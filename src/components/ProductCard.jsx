  ...
  return (
    ...
    >
      <div className="relative aspect-3/4 overflow-hidden bg-gray-100">
        ...
        {/* Add to Cart Overlay */}
        <div className={`absolute bottom-8 left-0 right-0 bg-white bg-opacity-95 transition-all duration-300 ${isHovered ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
      ...
      <div className="mt-4 space-y-1">
        ...
        <p className="text-primary font-semibold">NGN {product.price.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
      </div>
    </div>
  );
}
